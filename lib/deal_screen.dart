...
class _DealScreenState extends State<DealScreen> {
  ...
  void _getUserFavorite() {
    if(UserAttributes.favoriteBusiness.contains(widget.businessName)) {
      setState(() {
        likeButtonState = 1;
      });
    } else {
  ...
  void _getUserSaved() {
    if(UserAttributes.savedDeals.contains(widget.businessName)) {
      setState(() {
        saveButtonState = 1;
      });
    } else {
  ...
  void _setAsFavorite() async {
    PrefsService().getUserData().then((value) async {
      String favBusiness = UserAttributes.favoriteBusiness == " " ? "${widget.businessName}, " : "${UserAttributes.favoriteBusiness}${widget.businessName}, ";
      setState(() {
  ...
  void _unFavorite() async {
    PrefsService().getUserData().then((value) async {
      String favBusiness = UserAttributes.favoriteBusiness.replaceAll("${widget.businessName}, ", "");
      setState(() {
        UserAttributes.favoriteBusiness = favBusiness;
      });
      await FirebaseFirestore.instance.collection("Users").doc(FirebaseAuth.instance.currentUser?.uid).update({
  ...
  void _saveDeal() async {
    PrefsService().getUserData().then((value) async {
      String savedDeals = UserAttributes.savedDeals == " " ? "${widget.businessName}, " : "${UserAttributes.savedDeals}${widget.businessName}, ";
      setState(() {
  ...
  void _unSaveDeal() async {
    PrefsService().getUserData().then((value) async {
      String savedDeals = UserAttributes.savedDeals.replaceAll("${widget.businessName}, ", "");
      setState(() {
        UserAttributes.savedDeals = savedDeals;
      });
      await FirebaseFirestore.instance.collection("Users").doc(FirebaseAuth.instance.currentUser?.uid).update({
