...
class _HomeScreenState extends State<HomeScreen> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _shortcuts("Near Me", () {
                      Feedback.forTap(context);
                      widget.setStateMain(15);
                    }),
                    _shortcuts("Most Popular", () {
                      Feedback.forTap(context);
                      widget.setStateMain(17);
                    }),
                  ],
                ),
              ),
            ),
            _heading("Offers Near Me", 15),
            Container(
            ...
            UserAttributes.favoriteBusiness.trim().isNotEmpty ? _heading("Favorite Businesses", 16) : const SizedBox(),
  ...
  Widget _heading(String text, int state) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Feedback.forTap(context);
              widget.setStateMain(state);
            },
            child: _underlineText("See All"),
          ),
        ],
      ),
    );
