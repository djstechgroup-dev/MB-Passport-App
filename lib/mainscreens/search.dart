...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void getRecentSearch() {
    PrefsService().getRecentSearch().then((value) {
      setState(() {
        recentSearch.addAll(value.reversed);
      });
    });
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            recentSearch.isNotEmpty ? _headings("Recently Searched") : const SizedBox(),
            for(int i = 0; i < recentSearch.length && i < 5; i++)...<Widget>[
              recentSearch.isNotEmpty ? _searchHistoryItem(recentSearch[i])
                  : const SizedBox(),
            ],
