      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _headings("Recently Searched"),
            for(int i = 0; i < Attributes.latestSearch.length; i++)...<Widget>[
              _searchHistoryItem(Attributes.latestSearch[i]),
            ],
        ...
        child: Wrap(
          children: [
            Column(
              children: [
                Image.asset(
                  "assets/images/${screenState == 0 ? "todo_${Attributes.catToDoIcon[i]}.png"
                      : "toeat_${Attributes.catToEatIcon[i]}.png"}",
                ),
                Text(
