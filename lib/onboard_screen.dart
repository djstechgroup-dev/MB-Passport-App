...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  void getCurrentLocationAndWeather() async {
    await LocationService().getLatLong().then((value) {
      setState(() {
              ...
              onTap: () {
                ...
                try {
                  ...
                  AuthService().googleSignIn().then((value) async {
                    ...
                    var emailLogin = await AuthService().getUserToken(user?.email, userToken?.token);
                    await AuthService().saveUserData(user, userToken?.token);
