...
class SavedDealsViewHolder extends StatefulWidget {
  ...
  const SavedDealsViewHolder({Key? key, required this.imageURL, required this.businessName, required this.options, required this.tagline, required this.activeTo}) : super(key: key);
...
class _SavedDealsViewHolderState extends State<SavedDealsViewHolder> {
  ...
  Widget build(BuildContext context) {
    ...
    activeTo = DateTime.parse(widget.activeTo);
    late Widget body;
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Expires: ${activeTo.day}/${activeTo.month}",
                              style: TextStyle(
                                fontFamily: "Actor",
                                fontSize: screenHeight / 50,
                              ),
