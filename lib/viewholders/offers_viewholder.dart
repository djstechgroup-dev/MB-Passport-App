...
class _OffersViewHolderState extends State<OffersViewHolder> {
  ...
  void getOtherData() async {
    // LocationService().getLatLongFromAddress(widget.address).then((value) {
    //   if(value.isNotEmpty) {
    //     if(mounted) {
    //       setState(() {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            _labelOffers(1, calculated ? ((calculateDistance(Attributes.locationData?.latitude, Attributes.locationData?.longitude, lat, long) * 1000 / 1609.344)
