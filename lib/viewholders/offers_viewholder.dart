...
class OffersViewHolder extends StatefulWidget {
  ...
  final int used;
  const OffersViewHolder({Key? key, required this.imageURL, required this.category, required this.distance, required this.name, required this.tagline, required this.used, required this.totalOffers}) : super(key: key);
