...
class DealApi {
  Future<List<dynamic>> getAllDeals(String? token) async {
    try {
      ...
      final uri = Uri.http('localhost:8000', '/api/deals');
      final headers = {
  ...
  Future<DealData> getDealById(String? token, String? id) async {
    try {
      //Temporary 10.0.2.2:8000 for testing using emulator
      final uri = Uri.http('localhost:8000', '/api/deal/$id');
      final headers = {
        "Authorization": "Bearer $token",
        "Content-Type": "application/json",
      };
  ...
  Future<String> getDealOfTheDay(String? token) async {
    try {
      //Temporary 10.0.2.2:8000 for testing using emulator
      final uri = Uri.http('localhost:8000', '/api/dotd');
      final headers = {
        "Authorization": "Bearer $token",
        "Content-Type": "application/json",
      };
  ...
  void saveDeal(String? token, String? id) async {
    try {
      //Temporary 10.0.2.2:8000 for testing using emulator
      final uri = Uri.http('localhost:8000', '/api/save-deal/$id');
      final headers = {
        "Authorization": "Bearer $token",
        "Content-Type": "application/json",
      };
  ...
  void unSaveDeal(String? token, String? id) async {
    try {
      //Temporary 10.0.2.2:8000 for testing using emulator
      final uri = Uri.http('localhost:8000', '/api/remove-save-deal/$id');
      final headers = {
        "Authorization": "Bearer $token",
        "Content-Type": "application/json",
      };
